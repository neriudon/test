package todo.oauth.api.common.error;
...
/**
 * REST APIのエラーハンドリングのためにResponseEntityExceptionHandlerを継承したクラスを作成
 */
@ControllerAdvice
public class RestGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * handleExceptionInternalメソッドをオーバーライドして、BODYを出力するようにする
	 */
	@Override
