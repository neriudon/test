...
/**
 * 認可コードグラントで認可したとき用のコントローラ<br/>
 * わかりやすくするためtodo/authcodeにマッピングする
 */
@Controller
@RequestMapping("todo/authcode")
public class TodoAuthCodeGrantController {
	// 認可コードグラント用のサービス
	@Inject
	@Named("authCodeGrantTodoServiceImpl")
	...
	public String create(@Validated({ Default.class, TodoCreate.class }) TodoForm todoForm, BindingResult bindingResult,
		...
		return "redirect:/todo/authcode/list";
	}
	...
	@ResponseStatus(HttpStatus.OK)
	public String revokeTokenbyAuthCodeGrant(RedirectAttributes attributes) {
